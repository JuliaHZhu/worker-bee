...
_webhook_executor = ThreadPoolExecutor(max_workers=_MAX_WEBHOOK_WORKERS, thread_name_prefix="lark-webhook")
...
class LarkWebhookHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if event_type == "im.message.receive_v1":
            ...
            _webhook_executor.submit(self._handle_im_message, payload)
